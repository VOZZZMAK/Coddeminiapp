...
const storiesContent = [
  { title: "Подключаем эквайринг",   description: "Подключаем эквайринг: Быстрое подключение платежных систем для вашего бизнеса с минимальными комиссиями. Обеспечиваем безопасные и удобные платежи для ваших клиентов." },
  { title: "Расширенная статистика", description: "Расширенная статистика: Детальная аналитика по всем аспектам вашего бизнеса в одном месте. Отслеживайте ключевые метрики и принимайте обоснованные решения." },
  { title: "Индивидуальный код",     description: "Индивидуальный код: Разработка уникальных решений без использования шаблонных конструкторов. Полностью кастомизированные под ваши потребности IT-решения." },
  { title: "Лучший дизайн",          description: "Лучший дизайн: Оформление, которое точно соответствует вашим задачам и выделяет вас среди конкурентов. Современный UI/UX дизайн для максимальной конверсии." },
  { title: "Внедрение AI-технологий",       description: "Внедрение AI-технологий: Умные решения для вашего бизнеса. Автоматизация, аналитика и нейросети — всё под ваши задачи" }
];
